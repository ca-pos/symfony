...
$pages_h1 = [
    "Pas à pas" =>  [ //"Accueil",
     ...
     "Page de modification d'une annonce/recette",
     "Gestion des utilisateurs",
     "Créer une route d'accès à son propre compte",
